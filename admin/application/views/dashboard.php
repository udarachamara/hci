...
<!--   <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
 ...
 -->
  ...
  <!-- Page level plugins -->
  <script src="<?php echo base_url('public/plugins/admin-assets/'); ?>vendor/chart.js/Chart.min.js"></script>

  <!-- Page level custom scripts -->
  <script src="<?php echo base_url('public/plugins/admin-assets/'); ?>js/demo/chart-area-demo.js"></script>
  <script src="<?php echo base_url('public/plugins/admin-assets/'); ?>js/demo/chart-pie-demo.js"></script>
