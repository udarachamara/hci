...
<body id="page-top">
  ...
  <?php $this->load->view('subCategory/subCategory_form',$category); ?>
  ...
  <div id="wrapper">
    ...
    <?php $this->load->view('sections/topbar'); ?>
        ...
        <div class="container-fluid">
            <?php 
                $this->load->view('subCategory/subCategory_grid',$grid_data);
            ?>
    		...
    		processData: false,
				...
				success:function(response){
					...
					if(response.code==1000){
						...
						showErrorMsg("Data Insert Faild..!");
					}
				},
